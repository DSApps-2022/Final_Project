---
title: "DSApps 2020 @ TAU: Final Project"
...
* The grade would be based on 4 dimensions (each worth 25%):
  - Data usage: there are 3-4 datasets, strive to use all in BOTH parts
...
* There is another option to earn up to 10 points bonus:
  - The student with the highest classification accuracy in the predicition task will receive a 10 points bonus.
...
### `food_train.csv` and `food_test.csv`
...
### train and test images for all snack products
...
* A manual scanning got rid of completely useless images, but this does NOT mean the images are all accurate and the images are "perfect"
...
It is a not so good image because this is isn't the brand specified, Lay's is a very well known default-like brand for potato chips. It still says "potato chips", therefore the image and snack were not discarded.
...
In the [Price is Right!](https://github.com/DSApps-2020/HW6) competition (for which you are still welcome to submit predictions!) you had to predict the log-price of Women's shoes.
